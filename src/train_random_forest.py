...
results_by_fold = []
final_y_test, final_y_pred, feature_importances = None, None, None
...
for feature, importance in importances_sorted.items():
    modeling_log.append(f"  - {feature}: {importance:.4f}")
...
results = {
    ...
    'feature_importance': importances_sorted.to_dict()
}
...
print("Modelo Random Forest treinado. Resultados, métricas, gráficos e importância das features salvos com sucesso.")
